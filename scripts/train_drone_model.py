...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Fine-tune YOLOv8n on the prepared VisDrone YOLO dataset."
    )

    parser.add_argument(
        "--data",
        type=Path,
        default=Path("data/visdrone_yolo/data.yaml"),
    ...
    parser.add_argument(
        ...
        type=str,
        default=None,
        help="Training device. Use '0' for GPU or 'cpu' for CPU.",
    )

    parser.add_argument(
        "--name",
        type=str,
        default="yolov8n_drone",
    ...
    parser.add_argument(
        "--output-model",
        type=Path,
        default=Path("models/pc/yolov8n_drone.pt"),
...
def main() -> None:
    ...
    print("Starting YOLOv8 drone model fine-tuning...")
